/*
  ...
  2. If the current number is a prime number, add the current number in the sum.
     ...
     -> If the remainder of the argument (tmpNum) and the current num in the loop (i) is zero, 
        then it's not a prime number. Return false.
     -> If the loop has ended and no divisor (i) was found to get a non-zero remainder, return true. 
