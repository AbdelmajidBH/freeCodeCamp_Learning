/*
  ...
  6. If the remainder in step 5 is not zero, break out of the inner loop since the current value of multiple 
     is not a multiple of the current number in the inner loop (i). Increment multiple by max so we can try a new multiple.
  7. If the remainder in step 5 is zero, check for the next iteration in the inner loop.
  8. If step 7 is true for all numbers in the range, then the current multiple is the common multiple 
     for all numbers in the range. Return this multiple.
*/
